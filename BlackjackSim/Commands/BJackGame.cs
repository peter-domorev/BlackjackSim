...
namespace BJackSim
{
    class BJackGame
    {
        private List<BJackPlayer> _players;
        private BJackDealer _dealer;
        private Deck _deck;
        ...
        public BJackGame(List<BJackPlayer> players, BJackDealer dealer, Deck deck)
        {
            _players = players;
            _dealer = dealer;
            _deck = deck;
        ...
        private BJackGame(int NumDecks, int NumRounds, int Cash, int BetAmount, bool DoubleDownAllowed, bool SurrenderAllowed)
        {
            numDecks = NumDecks;
            numRounds = NumRounds;
            cash = Cash;
        ...
        /*private void ResetGame()
        {
            ...
            {
                foreach (Hand hand in _players.Hands)
                player.Hands.Clear();
            }
